...
" We include all remaining report lines in the quickfix buffer
CompilerSet efm=%+P[%f],%t:\ %#%l:%m,%Z,%+IYour\ code%m,%Z.%#

if g:pylint_onwrite
    augroup python
        au!
        au BufWritePost * if &filetype ==# 'python' | call Pylint(1) | endif
    augroup end
endif
